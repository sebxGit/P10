...
if __name__ == "__main__":
  ...
  for model in ensemble_models:
    ...
    if isinstance(model, torch.nn.Module):
      ...
      trainer = L.Trainer(max_epochs=_hparams['max_epochs'], callbacks=[EarlyStopping(monitor="train_loss", mode="min"), pred_writer], log_every_n_steps=_hparams['batch_size']//2, precision='16-mixed', enable_checkpointing=False, strategy='ddp_find_unused_parameters_true')
