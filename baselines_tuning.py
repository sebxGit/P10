...
def objective(args, trial):
    params = {  
        ...
        'seed': 42,
        'max_epochs': trial.suggest_int('max_epochs', 3000, 5000, step=100), ###CHANGE
        # 'max_epochs': 1000,
    ...
    if args.model == "LSTM":
      ...
      params_xpatch = Configs(
        ...
        patch_len = trial.suggest_int('patch_len', 2, 200, step=2),
        stride=trial.suggest_int('stride', 2, 200, step=2),
